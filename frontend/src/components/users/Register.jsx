...
const Register = () => {
  ...
  const [avatarPreview, setAvatarPreview] = useState(
    "/frontend/public/images/images.png"
  );


  //handle redirectionwith useEffect
  useEffect(()=>{
    if(isAuthenticated){
      navigate("/");
    }
  ...
  const submitHandler=(e)=>{
    ...
    const formData=new FormData(); //{name:Pooja, email:abc@gmail.com...}
    ...
    if(avatar===""){
      formData.set("avatar","/frontend/public/images/images.png");
    }else{
